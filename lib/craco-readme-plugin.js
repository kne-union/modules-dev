const {getLoader} = require("@kne/craco");
...
const ReadmePlugin = {
    overrideWebpackConfig: ({webpackConfig, context, pluginOptions}) => {
        const {loaderOptions, getModuleList, readmePath, docsDir} = Object.assign({}, pluginOptions);
        ...
        webpackConfig.plugins.push(new ReadmeWebpackPlugin({
            env: context.env, getModuleList, readmePath, docsDir
        }));
